...
class Domain(models.Model):
  ...
  went_over_manually = models.BooleanField("Went Over Manually", default=False)
  sent_manually = models.BooleanField("Sent Manually", default=False)
  emails_found = models.IntegerField('Emails Found', blank=True, default=0)
